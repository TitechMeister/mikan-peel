...
export default {
  ...
  methods: {
    ...
    async onButtonClick () {
      ...
      if (this.timecardState === StateToStart
  ...
  computed: {
    ...
    buttonText () {
      switch (this.timecardState) {
        case StateUnselected: return 'start'
        case StateToStart:    return 'start'
        case StateToEnd:      return 'end'
        case StateToModify:   return 'modify'
      }
    },
    buttonVariant () {
      switch (this.timecardState) {
        case StateUnselected: return 'outline-secondary'
        case StateToStart:    return 'outline-primary'
        case StateToEnd:      return 'outline-danger'
        case StateToModify:   return 'outline-info'
      }
    },
    buttonClass () {
    ...
    messageText () {
      switch (this.timecardState) {
        case StateUnselected: return 'Please select workplace'
        case StateToStart:    return 'Ready to start work'
        case StateToEnd:      return `Ready to finish work`
        case StateToModify:   return 'Changing workplace'
      }
    },
    messageClass () {
      if (this.selectedWorkplace === null || this.selectedWorkplace === -1) {
